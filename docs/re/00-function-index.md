...
| `sub_2870` | 主要函式  /  `sub_2B24`(追人)、`sub_2A54`(隨機遊走)、`sub_2870`(真的挪一格)、`sub_2778`(進得去嗎)、`sub_27CC`(剛空出來的格子)  / | `85-monsters-move-and-terrain-slows-them.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `sub_DB10` | `sub_DB10` 的 `> 0x7F` 分支  /  `TileAt` / `SetTileAt` 加 `if s.InCombat()`  / | `26-yell-words-of-power-shadowlords.md`, `35-harp-and-the-secret-door.md`, `52-one-coordinate-pair-one-tile-accessor.md`, `68-troll-bridge-and-collision.md`, `69-the-overworld-cannon-did-nothing.md`, `71-the-use-list-had-29-empty-slots.md`, `74-two-swamp-dice-and-an-unnamed-failure.md`, `75-open-did-nothing-outside-dungeons.md`, `76-jimmy-in-a-dungeon-disarms-not-unlocks.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `sub_DE74` | 主要函式  /  `sub_DEE4`(開關月門)、`sub_DE74`(這一顆算不算在場)、`sub_E084`(玩家踏上)、`sub_2870`(怪物踏上)  / | `86-tile-0xDC-is-an-open-moongate.md` |
| `sub_DEE4` | 主要函式  /  `sub_DEE4`(開關月門)、`sub_DE74`(這一顆算不算在場)、`sub_E084`(玩家踏上)、`sub_2870`(怪物踏上)  / | `31-line-of-sight.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `sub_DF84` | └ sub_DF84(相位 − '0')   ★ 查目的地並傳送 | `22-moongates.md` |
| `sub_E084` | 主要函式  /  `sub_DEE4`(開關月門)、`sub_DE74`(這一顆算不算在場)、`sub_E084`(玩家踏上)、`sub_2870`(怪物踏上)  / | `22-moongates.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `sub_29D64` | 主要函式  /  `sub_29D64`(重畫)、`sub_2E0E8`(罩子入口)、`sub_2DDB0`(flood fill)、`sub_2E1D0`(擋不擋)、`sub_2E8D0`(距離)、`sub_29304… | `31-line-of-sight.md`, `34-ending-trigger.md`, `50-hole-up-camp-sleep-repair.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `sub_2CBEC` | An Ylem(`sub_18C00` 的 32-case 消除表)、In Por(瞬移,`sub_2CBEC`)、 | `17-magic.md`, `83-monster-attacks-and-two-different-wind-rules.md` |
...
| `sub_2E21C` | 主要函式  /  `sub_29D64`(重畫)、`sub_2E0E8`(罩子入口)、`sub_2DDB0`(flood fill)、`sub_2E1D0`(擋不擋)、`sub_2E8D0`(距離)、`sub_29304… | `31-line-of-sight.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `byte_3E050` | if (byte_3E0A3 != byte_3E050[i]) return 0     ; 地點不符(月石埋在哪個地點) | `13-save-writing.md`, `22-moongates.md`, `33-get-command.md`, `44-use-item.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `byte_3E0AB` | `byte_3E0AB` / `byte_3E0AC`  /  載入視窗的左上角**什麼時候更新**(每步一格還是整塊跳)。引擎目前用「隊伍為中心的 32×32」近似,差異會影響怪出現在哪一側  / | `17-magic.md`, `38-terrain-movement-cost.md`, `82-the-overworld-world-turn.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `byte_3E0AC` | `byte_3E0AB` / `byte_3E0AC`  /  載入視窗的左上角**什麼時候更新**(每步一格還是整塊跳)。引擎目前用「隊伍為中心的 32×32」近似,差異會影響怪出現在哪一側  / | `38-terrain-movement-cost.md`, `82-the-overworld-world-turn.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `dword_3E46C` | ≥ 0x40  /  怪物  /  `cmp byte ptr dword_3E46C[eax*8], 40h`,與生物名表的 `CreatureBase` 同源  / | `10-shop-prices-and-trade.md`, `11-map-objects.md`, `33-get-command.md`, `36-sandalwood-box-npc-objects.md`, `48-dungeon-wandering-monster-and-arena.md`, `53-party-tile-and-the-arena-floor.md`, `65-the-wishing-well-easter-egg.md`, `67-corpser-and-the-sleeping-party-member.md`, `84-the-sailing-gate-and-the-wind-table.md` |
...
| `loc_2E11` | `loc_2E11` 是**移動**、`loc_2E1C` 是**跳過**。重新讀敵船那一段: | `84-the-sailing-gate-and-the-wind-table.md` |
| `loc_2E13` | loc_2E13:  push  edi            ; 槽號 | `84-the-sailing-gate-and-the-wind-table.md` |

...
| `sub_86C` | 1  /  `sub_31DC0` default、`sub_DF84`(月門傳送)、`sub_3FE4`(離開地牢)、`sub_86C`(方向樓梯)、`sub_1DA10`、`sub_177AC`、`sub_3FE4`… | `02-movement-and-tile-flags.md`, `03-scene-entry-and-tile-semantics.md`, `87-bgm-selection-and-the-tbl-tables.md`, `92-white-noise-shim-and-ambient-sound.md`, `98-select-menu-and-song-melody-matching.md`, `playtest-findings.md` |
...
| `sub_15F18` | `dword_3EF50` 的 +6 / +7 是戰場 X / Y —— 這一點由 `sub_15F18` 獨立確認: | `34-ending-trigger.md`, `playtest-findings.md` |
...
| `sub_2D174` | 主要函式  /  `sub_2CCFC`(★ 真正的航行閘門)、`sub_2D174`(移動分派)、`sub_2D014`(改座標)、`sub_2D2D0`(揚帆的節奏)、`sub_2B24`(★ 怪物移動)、`sub_… | `38-terrain-movement-cost.md`, `66-hexrays-truncation-audit.md`, `81-three-mode-loops-are-mutually-exclusive.md`, `83-monster-attacks-and-two-different-wind-rules.md`, `84-the-sailing-gate-and-the-wind-table.md`, `playtest-findings.md` |
...
| `byte_3E167` | `sub_2D174`  /  大地圖移動(由 `sub_2D9D0` 呼叫) /  `byte_3E167 == 0` —— 那是**帆船的航向**  / | `54-pass-vehicle-verbs-and-the-avatar-line.md`, `68-troll-bridge-and-collision.md`, `83-monster-attacks-and-two-different-wind-rules.md`, `playtest-findings.md` |

...
| `sub_86C` | 1  /  `sub_31DC0` default、`sub_DF84`(月門傳送)、`sub_3FE4`(離開地牢)、`sub_86C`(方向樓梯)、`sub_1DA10`、`sub_177AC`、`sub_3FE4`… | `02-movement-and-tile-flags.md`, `03-scene-entry-and-tile-semantics.md`, `87-bgm-selection-and-the-tbl-tables.md`, `92-white-noise-shim-and-ambient-sound.md` |
...
| `sub_1884` | 主要函式  /  `sub_1B3D0`(盤查)、`sub_1B52C`(對話分派)、`sub_195C`(碰到 NPC)、`sub_1884`(逮捕)、`sub_1B140`(密語比對)、`sub_154C` → `s… | `26-yell-words-of-power-shadowlords.md`, `28-shadowlords-and-blackthorn.md`, `29-npc-behaviour-and-arrest.md`, `32-guard-challenge.md`, `87-bgm-selection-and-the-tbl-tables.md` |
...
| `sub_A9EC` | 主要函式  /  `sub_18380`(ESC = 撤離)、`sub_A360`(戰鬥分派器)、`sub_42CC`(進地牢房間)、`sub_A9EC`(`byte_3E0B3` 的設定處)、`sub_2E364`(戰… | `16-combat-turns-and-ai.md`, `72-ready-had-seven-missing-rules.md`, `73-escape-is-a-key-and-it-has-two-gates.md`, `87-bgm-selection-and-the-tbl-tables.md` |
...
| `sub_13DD8` | `sub_13DD8`  /  `game.State.rollSearchFind` / `rollSearchJunk`  / | `41-jimmy-neworder-gem-ztats.md`, `43-search.md`, `92-white-noise-shim-and-ambient-sound.md` |
...
| `sub_16F08` | 上船唸一次 `Danger! Ship badly damaged!`(`sub_16F08`,`cmp eax, 0Ah`), | `11-map-objects.md`, `41-jimmy-neworder-gem-ztats.md`, `47-move-modes-and-time-of-day.md`, `60-command-echo-and-menu-keys.md`, `66-hexrays-truncation-audit.md`, `87-bgm-selection-and-the-tbl-tables.md`, `88-the-load-window-culling-and-ship-cannon.md` |
...
| `sub_1DA10` | `0x19`(25)  /  **the shrine of …**(八德聖壇;名字取自 `off_411BC[9]`,狀態看 `byte_411FC[8]`/`byte_41204[8]`)  /  `sub_1DA1… | `03-picture-files.md`, `03-scene-entry-and-tile-semantics.md`, `25-shrines.md`, `27-codex-and-the-shrine-chamber.md`, `28-shadowlords-and-blackthorn.md`, `34-ending-trigger.md`, `87-bgm-selection-and-the-tbl-tables.md` |
...
| `sub_20F24` | 主要函式  /  `sub_216C8`(酒館主流程)、`sub_210D8`(點餐)、★ `sub_20E6C`(算總價)、★★ `sub_20F60`(報價 + 收錢 + **上菜**)、★ `sub_20ED0`(… | `93-the-tavern-meal-was-never-haggled.md` |
...
| `sub_27D24` | 來源:FM Towns `WORRIORS.EXP` 的 `sub_27D24`(讀)與 `sub_284CC`(寫)。 | `07-save-format.md`, `10-shop-prices-and-trade.md`, `13-save-writing.md`, `26-yell-words-of-power-shadowlords.md`, `29-npc-behaviour-and-arrest.md`, `34-ending-trigger.md`, `73-escape-is-a-key-and-it-has-two-gates.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `sub_284CC` | 來源:FM Towns `WORRIORS.EXP` 的 `sub_27D24`(讀)與 `sub_284CC`(寫)。 | `07-save-format.md`, `13-save-writing.md`, `26-yell-words-of-power-shadowlords.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `sub_2D564` | `sub_1DA10`(聖壇)、`sub_2D564`(cave/mine/dungeon)、`sub_10928`(印地名並確認)。 | `03-scene-entry-and-tile-semantics.md`, `18-dungeons.md`, `26-yell-words-of-power-shadowlords.md`, `87-bgm-selection-and-the-tbl-tables.md` |
| `sub_2D72C` | 7  /  `sub_2D72C`(依腳下 tile 進場景)、`sub_1678`、`sub_C778`、跳表 case 62(走不到)  / | `03-scene-entry-and-tile-semantics.md`, `27-codex-and-the-shrine-chamber.md`, `87-bgm-selection-and-the-tbl-tables.md` |
...
| `sub_3181C` | 主要函式  /  `sub_3181C`(★ 播第 n 首)、`sub_313B8`(載入 `U5_BGM.TBL`)、`sub_31DC0`(★★ 開局挑曲)、`sub_31CB8`(當前曲號)、`sub_34685`… | `03-scene-entry-and-tile-semantics.md`, `27-codex-and-the-shrine-chamber.md`, `50-hole-up-camp-sleep-repair.md`, `87-bgm-selection-and-the-tbl-tables.md`, `audio-pipeline.md` |
...
| `byte_3E040` | ptr = tile_at(byte_3E040[i], byte_3E048[i])   ; ★★ 月石的 X / Y | `13-save-writing.md`, `22-moongates.md`, `33-get-command.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `byte_3E048` | ptr = tile_at(byte_3E040[i], byte_3E048[i])   ; ★★ 月石的 X / Y | `13-save-writing.md`, `22-moongates.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
| `byte_3E050` | 21..28  /  `(0`..`(7`  /  `byte_3E050[i] == 0xFF ? 0xFF : 0`  /  ⚠⚠ **沒寫完的佔位名**  / | `13-save-writing.md`, `22-moongates.md`, `33-get-command.md`, `44-use-item.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md`, `94-ztats-has-seventeen-pages.md` |
| `byte_3E058` | if (byte_3E058[i] != byte_3E0A5) return 0     ; 樓層不符 | `13-save-writing.md`, `22-moongates.md`, `71-the-use-list-had-29-empty-slots.md`, `86-tile-0xDC-is-an-open-moongate.md` |
...
| `byte_3E08B` | mov     al, byte ptr word_3E086     ← 把**隊伍的 x 座標低位元組**寫進 byte_3E08B | `37-look-signs-and-the-sky.md`, `52-one-coordinate-pair-one-tile-accessor.md`, `70-hunger-poison-and-the-vanishing-rings.md`, `75-open-did-nothing-outside-dungeons.md`, `93-the-tavern-meal-was-never-haggled.md` |
...
| `byte_3E08F` | } else if (byte_3E08F ∈ {6, 12, 18}) {                      ; ★ 6 / 12 / 18 點 | `04-npc-schedule-and-clock.md`, `10-shop-prices-and-trade.md`, `22-moongates.md`, `29-npc-behaviour-and-arrest.md`, `47-move-modes-and-time-of-day.md`, `50-hole-up-camp-sleep-repair.md`, `70-hunger-poison-and-the-vanishing-rings.md`, `82-the-overworld-world-turn.md`, `86-tile-0xDC-is-an-open-moongate.md`, `92-white-noise-shim-and-ambient-sound.md` |
| `byte_3E090` | if (byte_3E08F == byte_3E090) return                        ; 這個小時已經結算過 | `70-hunger-poison-and-the-vanishing-rings.md`, `92-white-noise-shim-and-ambient-sound.md` |
...
| `word_3DFB4` | if (word_3DFB4 == 0) {                                      ; ★ 存糧 0 | `10-shop-prices-and-trade.md`, `13-save-writing.md`, `33-get-command.md`, `70-hunger-poison-and-the-vanishing-rings.md`, `94-ztats-has-seventeen-pages.md` |
| `word_3DFB6` | `word_3DFB6` 是**金錢**(`docs/re/11` 的買馬那段:`sub word_3DFB6, ax ; 扣錢`)。 | `10-shop-prices-and-trade.md`, `11-map-objects.md`, `13-save-writing.md`, `33-get-command.md`, `65-the-wishing-well-easter-egg.md`, `68-troll-bridge-and-collision.md`, `94-ztats-has-seventeen-pages.md` |
| `word_3E084` | word_3E084 年 | `04-npc-schedule-and-clock.md` |
| `word_3E086` | sub_215C()                            ; 挑候選座標 → word_3E086 / word_3E088 | `16-combat-turns-and-ai.md`, `37-look-signs-and-the-sky.md`, `40-push-and-the-main-menu.md`, `49-command-table-and-two-empty-keys.md`, `68-troll-bridge-and-collision.md`, `69-the-overworld-cannon-did-nothing.md`, `72-ready-had-seven-missing-rules.md`, `82-the-overworld-world-turn.md` |
| `word_3E088` | sub_215C()                            ; 挑候選座標 → word_3E086 / word_3E088 | `16-combat-turns-and-ai.md`, `40-push-and-the-main-menu.md`, `49-command-table-and-two-empty-keys.md`, `82-the-overworld-world-turn.md` |
...
| `dword_3E46C` | ≥ 0x40  /  怪物  /  `cmp byte ptr dword_3E46C[eax*8], 40h`,與生物名表的 `CreatureBase` 同源  / | `10-shop-prices-and-trade.md`, `11-map-objects.md`, `33-get-command.md`, `36-sandalwood-box-npc-objects.md`, `48-dungeon-wandering-monster-and-arena.md`, `53-party-tile-and-the-arena-floor.md`, `65-the-wishing-well-easter-egg.md`, `67-corpser-and-the-sleeping-party-member.md`, `84-the-sailing-gate-and-the-wind-table.md`, `88-the-load-window-culling-and-ship-cannon.md` |

...
| `sub_1B52C` | 驗收:編號 0x70 → tile 368,算繪出來是持戟的鎧甲士兵,正對應 `sub_1B52C` 那句 | `04-npc-schedule-and-clock.md` |
| `sub_1B800` | call sub_1B800 | `05-text-compression.md` |
| `sub_1C3F8` | 來源:FM Towns `WORRIORS.EXP` 的 `sub_1C3F8`(展開)與 `dword_41990`(槽表); | `05-text-compression.md` |
| `sub_1C840` | `sub_1C840(id)`: | `05-text-compression.md` |

...
| **場景照明** | `sub_2E21C`;發光地形 `dword_601E4`(10 筆);光源半徑² 10 | ✅ **已實作**(`docs/re/31` §6):火盆 / 營火 / 月門各自照亮一圈,而且照不進隔壁房間;夜裡視野縮成九格,靠光源才看得遠。只差閃爍動畫 `sub_2E944` |
...
| **檀香木盒** | `sub_154BC` 0x0E;存檔 0x0219 | 🔶 可撿且存讀檔(真結局的條件)。⬜ **擺在哪裡**未找 |

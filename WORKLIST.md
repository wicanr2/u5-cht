...
| **遊戲機制** | 🔶 **約 87%**:地表走動、進出 32 個地點的場景、梯子(101 段測過)、時鐘與 NPC 排程、對話與入隊、八種商店的完整交易、休息與恢復規則、地圖物件層、上下載具、NPC 逐格尋路、存檔讀寫、戰鬥的觸發與布陣、**命中判定**。傷害值、敵人 AI、魔法、地牢仍未做 |
   ...
   **剩下(依序)**:
   ...
   4. **戰鬥** —— 🔶 地圖格式已解(docs/re/14)並有 `u5dump cbt` 可視驗收;
      ...
      **命中判定與四張數值表已解**(docs/re/15):
      ...
      裝備類別四張表都在 `DATA.OVL`。
      還缺:傷害值(`sub_B9A8`)、敵人 AI、多隻遭遇、逃跑判定。
   5. 魔法、地牢。

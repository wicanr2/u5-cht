...
| 指令系統 | `CMDS.OVL` 7,440 B | 🔶 已接:E 進入 / K 攀爬 / T 交談 / B・X 上下載具 / C 施法 / I 火把 / **Y 喊** / O 開箱 / **G 撿** / **L 看**(`docs/re/37`)/ **P 推**(`docs/re/40`:推不動自動改拉、椅子與大砲會轉向、大砲要專屬地板)。**Z 數值** / **J 撬鎖** / **N 換位** / **V 看寶石**(`docs/re/41`)。**R 拿武器** / **W 穿裝備**(`docs/re/42`:六個裝備欄位、換下來的回背包、第二把武器進副手)。⬜ 未接:F 開砲(`sub_172C4`)、M 調藥(`sub_18704`)、S 搜尋(`sub_147A8`)、U 用道具(`sub_1A5E8`)、D —— 處理函式都已定位 |

...
| 指令系統 | `CMDS.OVL` 7,440 B | 🔶 已接:E 進入 / K 攀爬 / T 交談 / B・X 上下載具 / C 施法 / I 火把 / **Y 喊** / O 開箱 / **G 撿** / **L 看**(`docs/re/37`)/ **P 推**(`docs/re/40`:推不動自動改拉、椅子與大砲會轉向、大砲要專屬地板)。⬜ 未接:Ztats(Z)、Ready(R)、Wear、Use、Search、Jimmy、Mix、Board 的部分變體 |

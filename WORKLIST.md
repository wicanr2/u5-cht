...
| **遊戲機制** | 🔶 **約 71%**:地表走動、進出 32 個地點的場景、梯子(101 段測過)、時鐘與 NPC 排程、對話與入隊、八種商店的完整交易、休息與恢復規則、**地圖物件層**。戰鬥、魔法、地牢、上下載具、NPC 尋路、存檔寫回仍未做 |
...
2. ~~場景地圖解碼~~ ✅(64 張 32×32);~~地點表~~ ✅(32 筆,`docs/re/03 §5`)。
   ...
   **剩下(依序)**:
   ...
   1. **Board / Exit**(上下坐騎與船)—— 買了馬看得到但騎不上去。`sub_2ACF4` case 66。

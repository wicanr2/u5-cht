...
**現況:可以走完一段路了。** 開場動畫、世界地圖、三十二個地點的場景、對話、八種商店、
戰鬥、魔法、地牢第一人稱透視都跑得起來;NPC 對白本文尚未翻譯(見下方「還沒到的地方」)。
...
- **NPC 對白本文尚未翻譯**。名字、物品、地名、怪物名、以及五個明文檔的
  ...
  但 `.TLK` 裡的對白本文還是英文(P5)。
- 黑棘的審問與結局這兩**幕還沒實作成遊戲場景** —— 譯文備好了,但玩家還看不到。
  (開場動畫與八座聖壇已經做好了。)
- **寶典**還沒做,所以聖壇的試煉旗標有一處簡化 —— 拜第二次就拿得到獎,
  原版要先去寶典一趟(`docs/re/25` §2.2 寫明了)。
- **音樂與音效還沒接**(P6)。

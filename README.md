...
| ![指令說明](docs/screenshots/23-help.png) | ![隊伍狀態](docs/screenshots/02-town.png) |
| **`F1` 指令說明** —— 原版把 A–Z 二十六個字母全用光了,1988 年靠的是紙本手冊。現在手邊沒那本書,所以「開門是哪個鍵」得在遊戲裡答得出來 | **隊伍狀態** —— 原版右欄是 `Elwood 60G`(HP 加一個狀態字母);這裡把字母展開成「康健 / 中毒 / 沉睡 / 身亡 / 被惑」,那是玩家要據此行動的資訊 |
